...
switch region
    ...
    case 'reg1p5'
        ...
        i_reg2 = ENV.NUM_CASES; %initialize as the last case, just incase really "bad" designs don't even have a region 2
...
for n = 1:numel(spd)
    ...
    if strcmp(TURB.CONTROL,'FSVP_F') || strcmp(TURB.CONTROL,'VSVP_F')
        if TURB.MONO_PITCH && ~strcmp(region,'reg1p5')
            LB = xBest;
        else
            LB = 0;
        end
