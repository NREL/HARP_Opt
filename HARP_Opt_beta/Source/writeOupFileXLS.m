...
xlwrite(SIM.xlsfile, geomData{:}       , 2, ['A6:G' num2str(2+WTP.NUM_SEG)]);
% xlwrite(SIM.xlsfile, cellstr(BLADE.afCoefFiles) , 2, ['H6:H' num2str(2+WTP.NUM_SEG)]);
%%
...
xlwrite(SIM.xlsfile, perfData{:}    , 2, ['J6:U' num2str(2+ENV.NUM_CASES)]);
